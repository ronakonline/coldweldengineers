                            ...
                            <div class="pl-lg-4">
                                ...
                                <div class="form-group{{ $errors->has('rank') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="number" name="rank" id="input-name"
                                        ...
                                        placeholder="{{ __('Rank') }}" value={{$company->rank}} required autofocus>
                                ...
                                <div class="form-group{{ $errors->has('is_active') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="checkbox" name="is_active"
                                        ...
                                        placeholder="{{ __('Active') }}" @checked($company->is_active) autofocus>
                                ...
                                <div class="form-group row preview">
                                    <div class="col-sm-12">
                                        <label class="col-form-label">Company Images</label>
                                        <div class="row">
