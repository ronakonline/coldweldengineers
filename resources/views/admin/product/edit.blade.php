                            ...
                            <div class="pl-lg-4">
                                <div class="form-group{{ $errors->has('title') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="title" id="input-name"
                                        ...
                                        placeholder="{{ __('Title') }}" required autofocus value={{ $product->title }}>
                                ...
                                <div class="form-group{{ $errors->has('desc') ? ' has-danger' : '' }}">
                                    ...
                                    <textarea id="editor" name="desc"
                                        class="form-control form-control-alternative{{ $errors->has('desc') ? ' is-invalid' : '' }}">{{ $product->desc }}</textarea>
                                ...
                                <div class="form-group{{ $errors->has('rank') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="number" name="rank" id="input-name"
                                        ...
                                        placeholder="{{ __('Rank') }}" value={{ $product->rank }} required autofocus>
                                ...
                                <div class="form-group{{ $errors->has('is_active') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="checkbox" name="is_active"
                                        ...
                                        placeholder="{{ __('Active') }}" @checked($product->is_active) autofocus>
